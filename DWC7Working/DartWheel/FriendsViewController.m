...
@interface FriendsViewController ()<AppDelegateDelegate>
...
- (void)viewDidLoad
{
    ...
    if (self.view.frame.size.height>500) {
         self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"gameover_i5.png"]];
    }else{
    
    self.view.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"gamover_i4.png"]];
    ...
    if (self.friendListArray.count<10) {
...
-(void) createUI{
    self.headerView = [[UIView alloc] initWithFrame:CGRectMake(5, 15, 314, 372)] ;
    ...
    [cancelButton setImage:[UIImage imageNamed:@"close_big.png"] forState:UIControlStateNormal];
    ...
    [sendButton setImage:[UIImage imageNamed:@"send_popup.png"]  forState:UIControlStateNormal];
    ...
    //===========
    //Add Title Label
    UILabel *noteLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 370, self.view.frame.size.width-20, 75)] ;
   
    noteLabel.textColor = [UIColor whiteColor];
    noteLabel.font = [UIFont boldSystemFontOfSize:13];
   // noteLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"name.png"]];
    noteLabel.backgroundColor=[UIColor clearColor];
    noteLabel.lineBreakMode=NSLineBreakByCharWrapping;
   // noteLabel.text=@"Note: You will get 1 life for every 2 friends.\nSo tag as many as you want.";
...
//    appDelegate.openGraphDict = storyDict;
    ...
    if (FBSession.activeSession.isOpen) {
        ...
        appDelegate.friendsCount=(int)self.selectedFriendsArray.count;
        NSLog(@"app.frnd count %d  selectd arr %lu", appDelegate.friendsCount ,(unsigned long)self.selectedFriendsArray.count);
        ...
        appDelegate.friendsCount=(int)self.selectedFriendsArray.count;
        NSLog(@"app.frnd count %d  selectd arr %lu", appDelegate.friendsCount ,(unsigned long)self.selectedFriendsArray.count);
        [appDelegate openSessionWithLoginUI:5 withParams:nil];
